	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// . _ - -> State 2
				else if ((currentChar == '.') || (currentChar == '_') || (currentChar == '-')) {	// Check for period, underscore, or minus sign
					nextState = 2;
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with A-Z\n";
		...
		case 1:
			...
			else if (userNameSize < input.length()) {
