...
public class StaffWindow {
	...
	public void show(Stage primaryStage) {
    	...
    	// Buttons for viewing pms, creating pms, and viewing reiews
		...
		// When a question is clicked, show who wrote the question, the question title, and question body, as well as any answers
